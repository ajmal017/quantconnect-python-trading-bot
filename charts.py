...
# Calculate and plot largest long/short positions
def PlotConcentrationChart(algorithm):
    long_max_val = 0
    short_max_val = 0
    long_min_val = 999999999
    short_min_val = 999999999

    # For each security in pf, take absolute holding value and whether long or short to find max long/short values
...
# Calculate and plot long/short stock counts
...
# Calculate and plot gross and net exposure
